...
- “打开鸡蛋设置”直接进入鸡蛋自己的可视设置驾驶舱，不弹第二张同义确认卡；
...
4. 安装、启动 Jidan，截取全屏主页、真正的鸡蛋设置驾驶舱，以及“支付宝转接头未接上”的诚实状态；
5. 用 XCUITest 像人一样点击两个真实按钮，检查支付宝文案，并确认鸡蛋设置驾驶舱显示 `JCL 0.1` 和 `NAVIGATION / DIRECT`；
...
- iOS 18.5 Simulator 实测中，Apple 的公开设置 URL 可能只落到“设置 → Apps”列表。因此主按钮直接打开 Jidan 自己的设置驾驶舱；我们不把“设置 App 进入前台”冒充成“目标页已经打开”。
